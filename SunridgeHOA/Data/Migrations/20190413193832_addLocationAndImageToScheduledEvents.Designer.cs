...
namespace SunridgeHOA.Data.Migrations
{
    ...
    [Migration("20190413193832_addLocationAndImageToScheduledEvents")]
    partial class addLocationAndImageToScheduledEvents
    {
            ...
            modelBuilder.Entity("SunridgeHOA.Models.Lot", b =>
                {
                    ...
                    b.HasOne("SunridgeHOA.Models.Owner", "Owner")
                        .WithOne("Lot")
                        .HasForeignKey("SunridgeHOA.Models.Lot", "OwnerID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
