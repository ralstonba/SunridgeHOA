...
namespace SunridgeHOA.Data.Migrations
{
    ...
    [Migration("20190414053117_AddComplaintFormStates")]
    partial class AddComplaintFormStates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SunridgeHOA.Models.ComplaintForm", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("StatesID1");

                    b.Property<string>("Suggestion");

                    b.HasKey("ID");

                    b.HasIndex("StatesID1");
            ...
            modelBuilder.Entity("SunridgeHOA.Models.States", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SunridgeHOA.Models.ComplaintForm", b =>
                {
                    b.HasOne("SunridgeHOA.Models.States", "States")
                        .WithMany()
                        .HasForeignKey("StatesID1");
                });
            ...
            modelBuilder.Entity("SunridgeHOA.Models.Owner", b =>
                {
                    ...
                    b.HasOne("SunridgeHOA.Models.ComplaintForm", "Form")
                        .WithMany()
