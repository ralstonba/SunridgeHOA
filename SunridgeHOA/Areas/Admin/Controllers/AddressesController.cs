...
namespace SunridgeHOA.Areas.Admin.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,StreetAddress,City,State,Zip,IsArchive,LastModifiedDate")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,StreetAddress,City,State,Zip,IsArchive,LastModifiedDate")] Address address)
        {
            if (id != address.ID)
            {
                return NotFound();
